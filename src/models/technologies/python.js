...
4.	Nel progetto HMAX, ho utilizzato Python per l’implementazione di alcuni DAG, ossia script schedulati ed eseguiti tramite l’utilizzo di Apache Airflow.`;

export class Python extends Technology {
    constructor() {
        super("Python", getLanguagesTitle(), content);
        this.setProjects(new NegozioPerfetto, new MBELab, new MagazzinoPerfetto, new TestCaseRunner, new FlowVehicle, new Hmax);
    }
}