...
export class NegozioPerfetto extends Project {
    constructor() {
        super("Negozio Perfetto", new Advise(), "https://www.negozioperfetto.it/", content);
        this.setGooglePlayStoreUrl("https://play.google.com/store/apps/details?id=advise.magazzinoperfetto&pli=1");
    }
}