...
STASH_NAME="stash-$(uuidgen)"

# Increase Project version
# Viene eseguita una stash preliminare per evitare l'errore: 'Git working directory not clean.'
# I file stashati verranno poi riattivati dopo l'incremento della versione.
